...
Knowing when to use an activity vs when to use a dialog fragment can be a challenge. It was rather difficult to figure out how to place the recycler view to the bottom of the toolbar inside a CoordinatorLayout.
